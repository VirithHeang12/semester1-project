<template>
    <div class="min-h-screen bg-slate-100">
        <div class="d-flex align-items-center container h-[500px] w-[1000px]" data-aos="flip-left"
            ...
            <div class="row d-flex align-items-center mt-[90px] rounded-[16px] bg-white">
                ...
                <div class="col-12 col-sm-12 col-md-6 lg:p-[24px]">
                    <div class="text-center ">
                        ...
                        <h1 class="lg:mb-[32px] md:mb-[10px] mb-[16px] text-[32px] font-semibold text-primary-600">
                            ចូលប្រើប្រាស់
                        </h1>
                    </div>
                    ...
                    <form method="POST">
                        ...
                        <div class="position-relative lg:mt-[24px] md:my-[10px] ">
                        ...
                        <div class="form-check lg:mt-[24px] md:mb-[16px] mt-[16px]">
                            <input type="checkbox" class="form-check-input custom-checkbox me-2" id="remember" />
                            <label class="form-check-label text-primary-700" for="remember">ចងចាំគណនីខ្ញុំ</label>
                        </div>

                        <!-- Submit button -->
                        <button type="submit" @click="loginCallback"
                        ...
                        <p class="text-center lg:mt-[16px] lg:mb-0 md:my-[12px] mt-[16px]"> <span
                                class="text-primary-700">មិនមានគណនីមែនទេ? </span><router-link :to="{ name: 'register' }"
                                class="text-gray-800 font-semibold">បង្កើតគណនី</router-link></p>
                    </form>
                </div>
            </div>
        </div>
