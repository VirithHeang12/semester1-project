<template>
          ...
          <v-row>
            <v-col cols="12" md="3" data-aos="fade-right">
              <v-list lines="one" select-strategy="leaf">
                <v-list-subheader class="mt-[-20px]">ប្រភេទសម្ភារៈ ក្នុងការិយាល័យ</v-list-subheader>
  ...
  const carouselItems = ref([
    {
      src: "/slide-groups/offices/office-8.jpg",
      lazySrc: "/thumbnails/bedroom-6.jpg",
    },
    {
      src: "/slide-groups/offices/office-9.jpg",
      lazySrc: "/thumbnails/bedroom-1.jpg",
    },
    {
      src: "/slide-groups/offices/office-10.jpg",
