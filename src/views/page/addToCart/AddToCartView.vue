        ...
        <v-container>
            <div class="flex flex-col align-start align-sub lg:flex-row gap-6">
                <div class="flex-1 bg-white p-4 rounded-lg">
                    ...
                    <!-- Cart Items Loop -->
                    <div v-for="(item, index) in cartItems" :key="index" class="border-b py-4 flex flex-col gap-4 lg:flex-row lg:items-center">
                        ...
                        <div class="flex items-center justify-between lg:w-1/6">
                            ...
                            <div class="flex items-center">
                                <!-- Decrement Button -->
                                <button type="button" id="decrement-button" @click="updateQuantity(index, -1)" class="bg-gray-100 flex items-center justify-center dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 border border-gray-300 rounded-l-md w-8 h-8 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
                                ...
                                <!-- Quantity Input -->
                                <input type="text" id="quantity-input" :value="item.quantity" readonly class="bg-gray-50 outline-none border-t border-b border-gray-300 h-8 w-10 text-center text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" aria-describedby="helper-text-explanation" required />
                                <!-- Increment Button -->
                                <button type="button" id="increment-button" @click="updateQuantity(index, 1)" class="bg-gray-100 flex items-center justify-center dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 border border-gray-300 rounded-r-md w-8 h-8 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
                        ...
                        <div class="flex items-center justify-end lg:w-1/6">
                            <button @click="removeItem(index)" class="text-red-500 hover:text-red-700">
                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6">
                                    ...
                                    <path d="M18.8332 8.5L18.3732 15.3991C18.1962 18.054 18.1077 19.3815 17.2427 20.1907C16.3777 21 15.0473 21 12.3865 21H11.6132C8.95235 21 7.62195 21 6.75694 20.1907C5.89194 19.3815 5.80344 18.054 5.62644 15.3991L5.1665 8.5" stroke="#9D1515" stroke-width="1.5" stroke-linecap="round"></path>
                ...
                <div class="w-full lg:w-1/3 bg-white p-4 rounded-lg">
                    ...
                    <button href="#payModal" data-bs-toggle="modal" @click="openPaymentModal" class="btn btn-dark w-full mt-4 bg-primary-800 round-[10px] text-primary-50 px-9 py-2 hover:bg-gray-800">
                        បញ្ជាទិញ
                    </button>
