<template>
    ...
    <v-container class="mt-5 px-0 py-0" :max-width="1200">
        ...
        <div class="mb-24 min-[350px]:mb-32 xl:mb-28">
            ...
            <v-container fluid>
                <v-row>
                    <v-col cols="12" md="4" class="-mb-20 min-[350px]:-mb-10 min-[380px]:-mb-6 flex flex-col min-[350px]:gap-y-1 min-[380px]:gap-y-10">
                    ...
                    <v-col cols="12" md="4" class="-mb-20 flex flex-col min-[350px]:-mb-16 min-[380px]:-mb-6">
                        <v-card elevation="0" class="bg-transparent -mb-24 min-[350px]:-mb-20 min-[380px]:-mb-12" data-aos="fade-down">
                            <router-link to="#">
        ...
        <div class="mb-16">
            <v-col cols="12" class="flex flex-col align-center gap-y-6 min-[600px]:flex min-[600px]:flex-row min-[600px]:justify-between" data-aos="fade-down">
                <the-featured-in-card class="bg-gray-100" v-for="featuredInItem in featuredInItems" :key="featuredInItem.title" :title="featuredInItem.title" :description="featuredInItem.description">
        ...
        <div class="mb-12">
            <v-col cols="12">
                <h2 data-aos="fade-down" class="mb-4 font-bold text-center min-[600px]:text-left text-gray-700 text-[1.5rem] lg:text-[2.2rem] xl:text-[2.5rem]">
                    ផលិតផលប្រចាំខែ</h2>
