        ...
        <v-row class="p-3">
            ...
            <v-col :cols="12" :sm="6" :md="5" :lg="4">
                <div class="relative h-auto w-auto lg:h-[550px] lg:w-[550px] lg:ml-auto">
                    <img :src="productDetails.url" alt="product" class="rounded-[20px] object-cover aspect-square w-full h-full" />
                    <span class="absolute left-3 top-3 rounded-xl bg-primary-600 px-4 py-[2px] text-sm font-light text-primary-50">
                        New
                    </span>
            ...
            <v-col :cols="12" :sm="6" :md="7" :lg="8" class="text-primary-900 h-full">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <div class="flex gap-3 ps-1">
                        ...
                        ]" :style="{ backgroundColor: color, outline: activeColor === color ? `2px solid ${color}` : '' }" @click="setActive(color)">
                        </div>
                    </div>
                </div>
                ...
                <div class="flex flex-col gap-2 my-5">
                    ...
                    <form class="max-w-xs">
                        <div class="relative flex items-center max-w-[7rem]">
                            <button type="button" id="decrement-button" data-input-counter-decrement="quantity-input" class="bg-gray-100 flex align-center dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 border border-gray-300 rounded-s-lg px-3 h-[33.5px] focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
                            ...
                            <input type="text" id="quantity-input" data-input-counter data-input-counter-min="1" aria-describedby="helper-text-explanation" class="bg-gray-50 outline-none border-top border-bottom border-gray-300 h-[33.5px] text-center text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 block w-full dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="1" required />
                            <button type="button" id="increment-button" data-input-counter-increment="quantity-input" class="bg-gray-100 flex align-center dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 border border-gray-300 rounded-e-lg px-3 h-[33.5px] focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
                ...
                <div class="flex gap-4 flex-col sm:flex-row">
                    ...
                    <button id="btn-add-to-cart" class="btn flex gap-2 border-primary-800 hover:bg-primary-800 hover:text-primary-50 outline-primary-700 rounded-[10px] text-primary-700 px-6 py-2">
                ...
                <div class="pt-2">
                    <p class="text-xs font-weight-regular flex items-center gap-2">
                        <svg width="20" height="12" viewBox="0 0 18 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M6.77461 8.19374H11.6152C11.7545 8.19374 11.888 8.13843 11.9865 8.03997C12.0849 7.94151 12.1402 7.80798 12.1402 7.66874L13.9684 0.974988C13.9684 0.905515 13.9546 0.836732 13.9278 0.772625C13.901 0.708519 13.8618 0.650363 13.8124 0.60153C13.763 0.552696 13.7044 0.514156 13.6399 0.488143C13.5755 0.46213 13.5066 0.449161 13.4371 0.449988H5.50273C5.36321 0.449986 5.22935 0.505198 5.13039 0.603566C5.03144 0.701933 4.97543 0.835463 4.97461 0.974988L3.41211 7.66874C3.41211 7.80798 3.46742 7.94151 3.56588 8.03997C3.66433 8.13843 3.79787 8.19374 3.93711 8.19374H4.61836" stroke="#454545" stroke-width="0.5" />
                            <path d="M13.0189 8.19378H11.9346L13.4971 2.79065H16.0658C16.1045 2.79056 16.1427 2.79891 16.1777 2.8151C16.2128 2.83129 16.2439 2.85494 16.2689 2.8844L17.3877 4.85315C17.4278 4.89904 17.45 4.95784 17.4502 5.01878L16.4096 8.19378H15.2846" stroke="#454545" stroke-width="0.5" />
                            <path d="M5.72187 9.70938C6.36218 9.70938 6.88125 9.18331 6.88125 8.53438C6.88125 7.88544 6.36218 7.35938 5.72187 7.35938C5.08157 7.35938 4.5625 7.88544 4.5625 8.53438C4.5625 9.18331 5.08157 9.70938 5.72187 9.70938Z" stroke="#454545" stroke-width="0.5" />
                            <path d="M14.1721 9.70938C14.8124 9.70938 15.3314 9.18331 15.3314 8.53438C15.3314 7.88544 14.8124 7.35938 14.1721 7.35938C13.5318 7.35938 13.0127 7.88544 13.0127 8.53438C13.0127 9.18331 13.5318 9.70938 14.1721 9.70938Z" stroke="#454545" stroke-width="0.5" />
                            <path d="M7.26523 1.98749H2.14648" stroke="#454545" stroke-width="0.5" stroke-linecap="round" />
                            <path d="M6.25625 3.625H2.64062" stroke="#454545" stroke-width="0.5" stroke-linecap="round" />
                            <path d="M6.62168 5.46875H1.00293" stroke="#454545" stroke-width="0.5" stroke-linecap="round" />
                        </svg>
            ...
            <v-col cols="12">
                <ul class="nav nav-underline justify-content-center border-bottom" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link px-6 active" id="description-tab" data-bs-toggle="tab" data-bs-target="#description-tab-pane" type="button" role="tab" aria-controls="description-tab-pane" aria-selected="true">ពិពណ៌នាទំនិញ</button>
                    </li>
                    <li class="nav-item" role="presentation">
