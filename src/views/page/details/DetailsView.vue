        ...
        <v-row class="p-3">
            ...
            <v-col :cols="12" :sm="6" :md="5" :lg="4">
                <div class="relative h-auto w-auto lg:h-[550px] lg:w-[550px] lg:ml-auto">
                    <img :src="productDetails.url" alt="product" class="rounded-[20px] object-cover aspect-square w-auto h-auto" />
            ...
            <v-col :cols="12" :sm="6" :md="7" :lg="8" class="text-primary-900 h-full">
                ...
                <div class="flex gap-4 flex-col sm:flex-row">
                    <button class="btn btn-dark bg-primary-800 rounded-[10px] text-primary-50 px-9 py-2">បញ្ជាទិញ</button>
                    ...
                    <div class="tab-pane fade show active" id="description-tab-pane" role="tabpanel" aria-labelledby="description-tab" tabindex="0">
                        <div class="flex justify-center">
                            <p class="text-center col-12 col-md-8 col-lg-6">
                                ត្រូវបានផលិតចេញពីសម្ភារៈដែលមានគុណភាពខ្ពស់ គ្រឿងសង្ហារឹមនីមួយៗត្រូវបានបង្កើតឡើងដើម្បីលម្អបន្ថែមសម្លេងស្ទីលដល់ផ្ទះរបស់អ្នក ហើយរឹងមាំបន្សល់ទុកអាយុកាលជាយូរអង្វែង។ ជាមួយនឹងរចនាបែបសាមញ្ញ និងមុខងារដែលអាចប្រើប្រាស់បានច្រើន គ្រឿងសង្ហារឹមរបស់យើងសាកសមសម្រាប់ការតុបតែងទាន់សម័យ បែបបុរាណ ឬបែបចម្រុះ។
                            </p>
                        </div>
                    ...
                    <div class="tab-pane fade" id="warranty-tab-pane" role="tabpanel" aria-labelledby="warranty-tab" tabindex="0">
                        <div class="flex justify-center">
                            <p class="col-12 col-md-8 col-lg-6 text-center">
                                ការធានារបស់យើងមានគោលបំណងដើម្បីធានាបាននូវគុណភាព និងភាពជឿជាក់លើគ្រឿងសង្ហារឹមដែលអ្នកបានទិញ។ សូមអានលក្ខខណ្ឌខាងក្រោម ដើម្បីដឹងច្បាស់ពីការធានា និងការការពារដែលបានផ្តល់ជូន៖
                            </p>
                        </div>
                        <div class="flex justify-center pt-2">
                            <div>
...
const productDetails = {
    title: "Infinito Wooden Gray Sofa",
    url: "/details/sample.png",
    price: '$699.00',
};
