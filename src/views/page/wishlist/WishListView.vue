        ...
        <v-container>
            ...
            <div class="flex flex-col min-[800px]:flex-row gap-6">
                <div class="flex-1 bg-white p-4 rounded-lg">
                    ...
                    <!-- Cart Items Loop -->
                    <div v-for="(item, index) in wishListItems" :key="index" class="border-b py-4 flex flex-col gap-4 min-[800px]:flex-row min-[800px]:items-center">
                        <!-- Product Image and Info -->
                        <div class="flex items-center w-full min-[800px]:w-1/6">
                            <img :src="item.href" alt="Product Image" class="w-48 h-48 min-[800px]:w-16 min-[800px]:h-16 rounded object-cover" />
                        </div>
