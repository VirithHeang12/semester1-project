<template>
    <v-app-bar :rounded="true" elevation="0" color="grey-lighten-3" absolute class="mt-4 rounded-lg lg:flex lg:justify-center xl:flex xl:justify-center">
        ...
        <v-app-bar-title v-if="!isMobile">
            <v-container class="flex mr-0 justify-between text-primary-900">
                <v-toolbar-items class="gap-2 md:pl-32 lg:pl-32 min-[1120px]:pl-24 xl:pl-72 min-[1450px]:pl-52">
                ...
                <v-toolbar-items class="extended hidden">
                    ...
                    <v-btn @click="toggleDarkMode" :ripple="false" variant="plain">
                        ...
                        <svg class="block dark:hidden" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <path opacity="0.5" d="M21.3334 2.66719L18.667 5.10509" stroke="#3D3D3D" stroke-width="1.5" stroke-linecap="round" />
                            <path opacity="0.5" d="M2.66663 2.66719L5.33304 5.10509" stroke="#3D3D3D" stroke-width="1.5" stroke-linecap="round" />
                            <path opacity="0.5" d="M5.33318 18.6668L2.6665 21.3335" stroke="#3D3D3D" stroke-width="1.5" stroke-linecap="round" />
                            <path opacity="0.5" d="M21.3334 21.3328L18.667 18.6661" stroke="#3D3D3D" stroke-width="1.5" stroke-linecap="round" />
                        </svg>
                    </v-btn>
