...
export default {
    ...
    computed: {
        fillHeart() {
            return this.clicked ? 'red' : '#D04E4E';
        },
        fillBackground() {
            return this.clicked ? '#dd9999' : 'white';
        },
        strokeWidth() {
            return this.clicked ? '1' : '0.5';
        },
        strokeColor() {
            return this.clicked ? '#fcfafa' : 'white';
        },
        strokeOpacity() {
            // Change the stroke to red when hovered or clicked
            return this.clicked ? '2' : '0.5';
        },
    },
    methods: {
        toggleClick() {
...
/* Define active or clicked state */
heart-svg:active {
