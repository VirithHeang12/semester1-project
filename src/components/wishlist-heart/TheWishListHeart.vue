  ...
  <div>
    <svg class="absolute top-3 right-3 cursor-pointer" :class="{
      ...
      <g filter="url(#filter0_b_255_363)">
        ...
        <rect id="heart-stroke" x="0.969238" y="0.666016" width="27.6009" height="27.6009" rx="13.8005" stroke="white" :stroke-opacity="strokeOpacity" stroke-width="0.5" />
      </g>
...
export default {
  ...
  computed: {
    strokeOpacity() {
      ...
      return this.clicked || this.hovered ? '1' : '0.3';
    },
  },
  methods: {
    toggleClick() {
